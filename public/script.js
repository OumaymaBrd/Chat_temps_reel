document.addEventListener("DOMContentLoaded", () => {
  ...
  const audioRecorderClose = document.getElementById("audio-recorder-close")
  ...
  const audioRecordPlayBtn = document.getElementById("audio-record-play-btn")
  const audioSendBtn = document.getElementById("audio-send-btn")
  const audioPlayer = document.getElementById("audio-player")
  const audioPreview = document.getElementById("audio-preview")
  const audioTimer = document.getElementById("audio-timer")
  const audioVisualizer = document.getElementById("audio-visualizer")
  const visualizerBars = audioVisualizer.querySelectorAll(".visualizer-bar")
  ...
  function playCallSound() {
    ...
    if (!callSound) {
      callSound = new Audio()
      callSound.src =
        "data:audio/mpeg;base64,"
    }
  ...
  audioRecordBtn.addEventListener("click", () => {
    // Fermer d'abord la prévisualisation de fichier si elle est ouverte
    closeFilePreview()

    // Afficher l'interface d'enregistrement audio
  ...
  audioRecorderClose.addEventListener("click", () => {
    closeAudioRecorder()
  })

  audioRecordStartBtn.addEventListener("click", startAudioRecording)
  audioRecordStopBtn.addEventListener("click", stopAudioRecording)
  audioRecordPlayBtn.addEventListener("click", playAudioRecording)
  ...
  function resetAudioRecorder() {
    ...
    audioRecordStartBtn.classList.remove("hidden")
    audioRecordStopBtn.classList.add("hidden")
    audioRecordPlayBtn.classList.add("hidden")
    audioPreview.classList.add("hidden")
    audioSendBtn.classList.add("hidden")
  ...
  function closeAudioRecorder() {
    ...
    // Libérer l'URL de l'audio si elle existe
    if (audioURL) {
  ...
  async function startAudioRecording() {
    try {
      ...
      mediaRecorder.onstop = () => {
        ...
        // Créer l'URL pour la lecture
        audioURL = URL.createObjectURL(audioBlob)

        // Configurer le lecteur audio
        audioPlayer.src = audioURL

        // Afficher les contrôles de lecture et d'envoi
        audioRecordPlayBtn.classList.remove("hidden")
        audioPreview.classList.remove("hidden")
        audioSendBtn.classList.remove("hidden")
      ...
      audioRecordStartBtn.classList.add("hidden")
      audioRecordStopBtn.classList.remove("hidden")
  ...
  function setupAudioAnalyser(stream) {
    try {
      ...
      // Configurer l'animation du visualiseur
      ...
      function animateVisualizer() {
        ...
        // Calculer la moyenne des fréquences pour chaque barre
        const barCount = visualizerBars.length
        const segmentLength = Math.floor(bufferLength / barCount)

        for (let i = 0; i < barCount; i++) {
          let sum = 0
          for (let j = 0; j < segmentLength; j++) {
            sum += dataArray[i * segmentLength + j]
          }
          const average = sum / segmentLength

          // Mettre à jour la hauteur de la barre (max 60px)
          const height = Math.max(10, Math.min(60, average * 0.6))
  ...
  function updateRecordingTimer() {
    ...
    // Limiter l'enregistrement à 5 minutes
    if (elapsed >= 300) {
      stopAudioRecording()
    }
  }
  ...
  async function sendAudioRecording() {
    ...
    try {
      ...
      const audioMessage = `AUDIO:${data.file.type}:audio.webm:${data.file.url}`
      ...
      // Fermer l'interface d'enregistrement
      closeAudioRecorder()
    } catch (error) {
      console.error("Erreur lors de l'envoi de l'audio:", error)
      alert("Erreur lors de l'envoi de l'audio: " + error.message)
    }
  }
  ...
  function addMessageToChat(data, isSelf = false) {
    ...
    if (data.message.startsWith("LOCATION:")) {
      ...
      const audioInfo = data.message.split(":")
      const audioType = audioInfo[1]
      const audioName = audioInfo[2]
      const audioUrl = audioInfo[3]

      messageContent.textContent = `A partagé un message audio`
      messageDiv.appendChild(messageContent)

      const audioElement = document.createElement("audio")
      audioElement.controls = true
      audioElement.src = audioUrl
      audioElement.classList.add("audio-player-message")
